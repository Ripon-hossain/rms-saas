        ...
        <div class="panel panel-bd">
            ...
            <div class="panel-body">
                ...
                <div class="col-lg-6">
                    ...
                    <div class="form-group row">
                        <label for="firstname" class="col-sm-5 col-form-label"><?php echo "No Vat" ?> <a class="cattooltips" data-toggle="tooltip" data-placement="top" title="If use Food Special Offer then check it and fill necessary field"><i class="fa fa-question-circle" aria-hidden="true"></i></a></label>
                        <div class="col-sm-2">
                            <div class="checkbox checkbox-success">
                                <input type="checkbox" name="novat" value="1" <?php if (!empty($productinfo)) if ($productinfo->novat == 1) {
                                                                                    echo "checked";
                                                                                } ?> id="novat">
                                <label for="novat"></label>
                            </div>
                        </div>
