...
<script src="<?php echo base_url('application/modules/ordermanage/assets/js/postop.js'); ?>"
  type="text/javascript"></script>
<?php
(int) $new_version = file_get_contents('https://update.demo.com/bhojon/autoupdate/update_info');
            ...
            <form name="calc">
              ...
              <div class="calcbuttons">
                <div class="calcrow">
                  ...
                  <button type="button" data-dismiss="modal" aria-label="Close"> <i class="fa fa-power-off"
      ...
      <div class="modal-body">
        ...
        <div class="form-group row">
          <label for="mobile" class="col-sm-3 col-form-label"><?php echo display('mobile'); ?> <i
              class="text-danger">*</i></label>
          <div class="col-sm-6">
            <input class="form-control" name="mobile" id="mobile" type="number" placeholder="Customer Mobile"
              required="" min="0">
          </div>
        </div>
        <div class="form-group row">
    ...
    <div class="panel-body">
      <div class="tabsection"> <span class="display-none"><?php echo $settinginfo->language; ?></span>
        <ul class="nav nav-tabs mb-2" role="tablist">
          ...
          <li class="active"> <a href="#home" role="tab" data-toggle="tab" title="<?php echo display('nw_order') ?>"
              id="fhome" autofocus class="home newtab" onclick="giveselecttab(this)"><i
                class="fa fa-plus smallview"></i> <span class="responsiveview"><?php echo display('nw_order'); ?></span>
            </a></li>
          ...
          <?php if ($qrapp == 1) { ?>
            <li class="seelist2"> <a href="#qrorder" role="tab" data-toggle="tab" id="todayqrorder" class="home newtab"
                onclick="giveselecttab(this)"><i class="fa fa-qrcode smallview"></i> <span
                  class="responsiveview"><?php echo display('qr-order'); ?></span> </a> <a href="" class="notif2"><span
                  class="label label-danger count2">0</span></a> </li>
          <?php } ?>
          <li class="seelist"> <a href="#settings" role="tab" data-toggle="tab" class="comorder newtab"
              id="todayonlieorder" onclick="giveselecttab(this)"><i class="fa fa-shopping-bag smallview"></i> <span
                class="responsiveview"><?php echo display('onlineord'); ?></span> </a> <a href="" class="notif"><span
                class="label label-danger count">0</span></a> </li>
        ...
        <div class="tgbar">
          ...
          <a id="fullscreen" href="#"><i class="pe-7s-expand1"></i></a> <a href="#"><i
              ...
              data-placement="bottom" data-content="<table class='table table-condensed table-striped' >
        <tr>
            <th>Operations</th>
            <th>Keyboard Shortcut</th>
            <th>Operations</th>
            ...
            <div class="col-sm-12 col-md-12">
              <div class="panel">
                ...
                <div class="row">
                      ...
                      <div class="col-md-12">
                        <form class="navbar-search" method="get"
                          ...
                          <div class="input-group">
                            <select id="product_name" class="form-control dont-select-me  search-field" dir="ltr"
                              name="s">
                            </select>
                          </div>
                        </form>
                        ...
                        <div class="product-category">
                          ...
                          foreach ($allcategorylist as $category) {
                            ...
                            <?php } else { ?>
                              ...
                              <div class="listcatnew cat-nav" onclick="getslcategory(<?php echo $category->CategoryID; ?>)">
                              ...
                              foreach ($itemlist as $item) {
                                ...
                                <div class="col-xs-6 col-sm-4 col-md-4 col-lg-3 col-p-3">
                                  <div class="panel panel-bd product-panel select_product">
                                    ...
                                    <div class="panel-footer"><span><?php echo $item->ProductName; ?>
                  ...
                  <div class="col-md-5">
                    <form action="<?php echo base_url("ordermanage/order/pos_order") ?>" class="form-vertical"
                      ...
                      <div class="row">
                        <div class="col-md-6 form-group">
                          ...
                          <div class="d-flex">
                            ...
                            <button type="button" class="btn btn-primary ml-l" aria-hidden="true" data-toggle="modal"
                        ...
                        <div id="nonthirdparty" class="col-md-12">
                          <div class="row">
                            ...
                            if ($possetting->tablemaping == 1) {
                              ...
                              <div class="col-md-2 form-group pl-0" id="tblsecp">
                                <label for="store_id" class="wpr_100 person"> <span
                                    class="color-red">&nbsp;&nbsp;</span></label>
                                <input name="" type="button" class="btn btn-primary  form-control width-auto"
                                  onclick="showTablemodal()" id="table_person" value="<?php echo display('person'); ?>">
                                <input type="hidden" id="table_member" name="table_member" class="form-control"
                                  value="" />
                              </div>
                            <?php } ?>
                            <div class="col-md-3 form-group" id="tblsec">
                              ...
                              <input type="hidden" id="table_member_multi_person" name="table_member_multi_person"
                                class="form-control" value="0" />
                                  ...
                                  foreach ($cart as $item) {
                                    ...
                                    <tr id="<?php echo $i; ?>">
                                      ...
                                      ?><a class="serach pl-15"
                                          ...
                                          title="<?php echo display('foodnote') ?>"> <i class="fa fa-sticky-note"
                                      ...
                                      <td scope="row"><a class="btn btn-info btn-sm btnleftalign"
                                          ...
                                          <?php echo $item['qty']; ?> </span> <a class="btn btn-danger btn-sm btnrightalign"
                                      ...
                                      <td width:"80"=""><a class="btn btn-danger btn-sm btnrightalign"
                                          onclick="removecart('<?php echo $item['rowid']; ?>')"><i class="fa fa-trash-o"
                      ...
                      <div class="fixedclasspos">
                        <div class="row d-flex flex-wrap align-items-center">
                              ...
                              <tr>
                                <td><label for="date" class="col-sm-8 mb-0"><?php echo display('service_chrg') ?>
                                  ...
                                  <div class="col-sm-4 p-0">
                                    <input type="text" id="service_charge" onkeyup="calculatetotal();"
                                      class="form-control text-right mb-5" value="<?php echo $servicecharge; ?>"
                          ...
                          <div class="col-sm-6 text-right"> <a class="btn btn-primary cusbtn" data-toggle="modal"
                              data-target="#exampleModal"><i class="fa fa-calculator" aria-hidden="true"></i></a> <a
                            ...
                            <input type="button" id="add_payment2" class="btn btn-primary btn-large cusbtn"
                              onclick="quickorder()" name="add-payment" value="<?php echo display('quickorder') ?>">
                            <input type="button" id="add_payment" class="btn btn-success btn-large cusbtn"
                              onclick="placeorder()" name="add-payment" value="<?php echo display('placeorder') ?>">
...
<script src="<?php echo base_url('application/modules/ordermanage/assets/js/possetting.js'); ?>"
  type="text/javascript"></script>