            ...
            <div class="panel-heading">
                ...
                <div class="panel-body">
                 ...
                 <p align="center"><strong><?php echo display('waiter_app')?> QR Scan</strong></p>
                  ...
                  <p><a href="https://play.google.com/store/apps/details?id=com.demo.kitchenchef" target="_blank"><img src="<?php echo base_url(); ?>assets/img/appsicon.png" alt="apps" width="50px;"/> <?php echo display('kitchen_app')?></a></p>
                  <p><a href="https://play.google.com/store/apps/details?id=com.demo.waiters" target="_blank"><img src="<?php echo base_url(); ?>assets/img/appsicon.png" alt="apps" width="50px;"/> <?php echo display('waiter_app')?></a></p>
                  <p><a href="https://play.google.com/store/apps/details?id=com.demo.hungry" target="_blank"><img src="<?php echo base_url(); ?>assets/img/appsicon.png" alt="apps" width="50px;"/> <?php echo display('customer_app')?></a></p>
                  </div>
