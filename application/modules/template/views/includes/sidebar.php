	...
	<ul class="sidebar-menu">
        ...
        ************************************* -->
		...
		$HmvcMenu2["setting"] = array(
			...
			"customer_type" => array(
				...
				// "cust_list" => array("controller" => "custlist", "method"  => "list", "permission" => "read"),
				"membership_list" => array("controller" => "membership", "method"  => "index", "permission" => "read"),
			...
			"company" => array("controller" => "company", "method" => "index", "permission" => "read"),
        ...
        ************************************* -->
		...
		<li class="header">Default </li>
			...
			<li class="treeview <?php echo (($this->uri->segment(2) == "home" || $this->uri->segment(2) == "") ? "active" : null) ?>">
			<a href="<?php echo base_url('CacheController/clearCache') ?>"><i class='fa fa-gear' aria-hidden='true'></i> <span><?php echo "Cache Clear" ?></span>
			</a>
		</li>
