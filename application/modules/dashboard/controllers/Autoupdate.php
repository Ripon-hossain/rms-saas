...
//Get Update file
define('MIN_VERSION', file_get_contents('https://update.demo.com/bhojon/autoupdate/update_min_version'));
//Get Update file
define('MAX_VERSION', file_get_contents('https://update.demo.com/bhojon/autoupdate/update_max_version'));

//Get Update file
define('UPDATE_URL','https://update.demo.com/bhojon/autoupdate');
// Get latest version info
define('UPDATE_INFO_URL','https://update.demo.com/bhojon/autoupdate/update_info');
// CRM temporary path
