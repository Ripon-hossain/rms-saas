...
class App extends MY_Controller
{
	...
	public function printinvoice()
	{
		...
		if (!empty($orderinfo)) {
			foreach ($orderinfo as $row) {
				...
				$output['orderinfo'][$o]['powerby'] = display('powerbydemo');
				$o++;
			}
			return $this->respondWithSuccess('Informations d\'impression.', $output);
		} else {
	...
	public function checkpurchasekey()
	{
		...
		curl_setopt_array($curl, array(
			CURLOPT_URL => 'https://store.demo.com/class.api.php?domain=' . $domain . '&product_key=' . $producrtkey . '&purchase_key=' . $purchasekey . '',
