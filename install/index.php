    ...
    <body>
            ...
            <div class="container"> 
                ...
                <div class="row"> 
                    <div class="col-md-10 col-md-offset-1 col-sm-10 col-sm-offset-1"> 
                        <header class="header">
                            <h1 class="header-title">demo software installer</h1>
                        </header>
                                        ...
                                        <h1>Verification</h1>
                                         ...
                                         <div class="row">
                                            <div class="col-md-12">
                                                ...
                                                <a target="_blank" class="btn btn-warning pull-right" href="https://www.demo.com/license-update.php?<?php echo 'product_key='.$Verification->get_product_key().'&'.'purchase_key='.base64_encode(filterInput($_GET['purchase_key']));?>" role="button">Update Purchase Key</a>
                                            ...
                                            <div class="row">
                                                <div class="col-sm-8">
                                                    <div class="form-group">
                                                        <label for="userid" class="col-sm-4 col-form-label">Envato User ID <span class="glyphicon glyphicon-question-sign" data-toggle="tooltip" data-placement="bottom" title="Enter Envato User ID or Enter 'demo' as non Envato User">
                                                        </span> </label>
                                                        <div class="col-sm-8">
                                                    ...
                                                    <div class="form-group">
                                                        <label for="purchase_key" class="col-sm-4 col-form-label">Purchase Key <span class="glyphicon glyphicon-question-sign" data-toggle="tooltip" data-placement="bottom" title="Enter Purchase Key which you got by envato purchase or demo support.">
                                                        </span></label>
                                                        <div class="col-sm-8">
        ...
        <footer class="footer text-center">
            <div class="container fText">
                <div class="col-md-10 col-md-offset-1 col-sm-10 col-sm-offset-1">
                    <div class="row">
                        <div class="col-sm-6 text-left">Developed by <a  target="_blank" href="https://www.demo.com/">demo</a></div>
                        <div class="col-sm-6  text-right"><a target="_blank" href="https://forum.demo.com/"><span class="glyphicon glyphicon-user"></span> Installation Support</a></div>
                    </div>
                </div>
            </div>
        </footer>
